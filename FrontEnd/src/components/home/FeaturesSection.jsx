  ...
  const features = [
    {
      ...
      description:
        "Identifikasi potensi penyakit berdasarkan gejala yang Anda alami dengan teknologi machine learning terkini.",
    },
    {
      id: 2,
      icon: <FaPills />,
      ...
      description:
        "Dapatkan saran pengobatan awal berdasarkan hasil deteksi penyakit yang teridentifikasi.",
    },
    {
      id: 3,
      icon: <FaComments />,
      ...
      description:
        "Dapatkan umpan balik langsung tentang spesifisitas keluhan Anda untuk meningkatkan akurasi diagnosis.",
    },
    {
      id: 4,
      icon: <FaBookMedical />,
      title: "Edukatif",
      description:
        "Tingkatkan pengetahuan kesehatan Anda melalui artikel dan informasi preventif terkini.",
    },
  ];
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-text-secondary text-lg">
            Platform kesehatan interaktif yang memadukan teknologi untuk
            memberikan solusi kesehatan yang tepat
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-text-secondary mb-6">
                Teknologi kecerdasan buatan kami mampu menganalisis kombinasi
                gejala untuk memberikan prediksi penyakit yang akurat dan
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    Algoritma Random Forest yang terlatih dengan jutaan data
                    gejala
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    Input dinamis yang meminta detail tambahan saat diperlukan
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <svg
                  ...
                  <span>
                    Sistem yang terus berkembang seiring bertambahnya data
                  </span>
                </li>
              </ul>
            </div>
            <div className="bg-white rounded-xl shadow-md p-6 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <div className="flex justify-between mb-1">
                      <span className="font-medium">Hipertensi</span>
